            ...
            <ProjectModal id="rumble">
                <section>
                    ...
                    <div>
                        ...
                        <a href="https://github.com/codingTeamLHLR/eventplanningtool_client"> Open project on github (front end)</a>
                        {/* <Button onClick={handleClickGit} showIcon={true} variant="primary" text={'check out my projects'}/> */}
                        <a href="https://github.com/codingTeamLHLR/eventplanningtool_server" >Open project on github (back end)</a>
                    </div>
                </section>
            </ProjectModal>
